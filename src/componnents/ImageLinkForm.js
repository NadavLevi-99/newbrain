...
const ImageLinkForm = ({ onInputChange, onButtonClick }) => {
  ...
  return(
    ...
    <div  class="pa4 black-80 measure">
      ...
      <input style={{display:'flex' ,flexGrow:'3'}} id="name" class="input-reset ba b--black-20 pa2 mb2 db w-70 " type="text" aria-describedby="name-desc" placeholder='Image URL' onChange={onInputChange}/>
